...
(function($, window, document, undefined) {
    ...
    var defaults = {
        ...
        emptyClass: 'dd-empty',
        expandBtnHTML: '<button class="dd-expand" data-action="expand" type="button"><i class="fa fa-folder-o"></i></button>',
        collapseBtnHTML: '<button class="dd-collapse" data-action="collapse" type="button"><i class="fa fa-folder-open-o"></i></button>',
        group: 0,
        maxDepth: 5,
        threshold: 20,
        ...
        endEvent: function(e) {return true},
    ...
    Plugin.prototype = {
        ...
        init: function() {
            ...
            var onStartEvent = function(e) {
                ...
                if(list.options.itemClick){
                    if(!list.options.itemClick($(e.target))){
                        return;
                    }
                }

                list.options.clickTimer = setTimeout(function(){
            ...
            list.el.on('mouseup', function(){clearTimeout(list.options.clickTimer)});
        ...
        _buildItem: function(item, options) {
            ...
            html.find('.dd-content>span').each(function () {
                var backgroundColor = '';
        ...
        setParent: function(li) {
            ...
            // if (li.is(this.options.itemNodeName) && li.children(this.options.listNodeName).length>0&&li.attr("data-groupsign")==0) {
            if (li.is(this.options.itemNodeName) && li.attr("data-groupsign")==0) {
        ...
        dragStop: function(e) {
            ...
            } if(!$(e.target).closest('li').attr("data-type")==0){
                        list.dragStop(e.touches ? e.changedTouches[0] : e);
                    }
            else {
